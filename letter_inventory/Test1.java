...
public class Test1 {
    public static void main(String[] args) {
        ...
        LetterInventory abc = new LetterInventory("abc");
        LetterInventory e = new LetterInventory("abc");
        LetterInventory dx = new LetterInventory("xxx");
        LetterInventory d = abc.subtract(e);
        LetterInventory cc = abc.subtract(dx);
