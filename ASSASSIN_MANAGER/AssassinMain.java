...
public class AssassinMain {
    ...
    public static void oneKill(Scanner console, AssassinManager manager) {
        ...
        //System.out.println(name +" chet chua?" +manager.graveyardContains(name));
        //System.out.println(name +" khong o trong kill ring " +manager.killRingContains(name));
        ...
        if (manager.graveyardContains(name)) {
            ...
            //System.out.println("giet thang "+name);
            manager.kill(name);
        }
        System.out.println();
        //System.out.println("Chet mot dua");
    }
